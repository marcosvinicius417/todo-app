...
<div class="max-w-2xl mx-auto p-6 bg-white shadow-md rounded-xl mt-10">
    ...
    <form method="POST" action="<?php echo e(route('tasks.store')); ?>" class="space-y-4">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\marco\OneDrive\Área de Trabalho\Laravel Test\todo-app\resources\views/tasks/create.blade.php ENDPATH**/ ?>